 ...
 *
 * Runs when CodeBuddy session ends. Extracts a meaningful summary from
...
function buildSummarySection(summary) {
  ...
  // Tasks (from user messages 鈥?collapse newlines and escape backticks to prevent markdown breaks)
  section += '### Tasks\n';
