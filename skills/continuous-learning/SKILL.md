...
- Reviewing or curating learned skills in `~/.codebuddy/skills/learned/`
...
3. **Skill Extraction**: Saves useful patterns to `~/.codebuddy/skills/learned/`
...
Add to your `~/.codebuddy/settings.json`:
